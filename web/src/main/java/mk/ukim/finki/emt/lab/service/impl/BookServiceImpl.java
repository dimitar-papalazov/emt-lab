...
public class BookServiceImpl implements BookService {
    ...
    public Optional<Book> save(BookDto bookDto) {
        Author author =
                this.authorRepository.findById(bookDto.getAuthor()).orElseThrow(() -> new
                        AuthorNotFoundException(bookDto.getAuthor()));
    ...
    public Optional<Book> edit(Long id, BookDto bookDto) {
        Book book =
                this.bookRepository.findById(id).orElseThrow(() -> new BookNotFoundException(id));
    ...
    public Optional<Book> markAsTaken(Long id) {
        ...
        book.setAvailableCopies(book.getAvailableCopies() == 0 ? 0 : book.getAvailableCopies() - 1);
